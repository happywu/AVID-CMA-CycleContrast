...
class ResNet(torchvision.models.resnet.ResNet):
    def __init__(self, block, layers, **kwargs):
        ...
        if 'return_before_avgpool' in kwargs:
            self.return_before_avgpool = kwargs['return_before_avgpool']
            del kwargs['return_before_avgpool']
        else:
            self.return_before_avgpool = False
